...
import com.cjnoyessw.twitter.hadoop.reducer.GeoTrendReducer;
import com.cjnoyessw.twitter.hadoop.mapper.GeoTrendMapper;
import com.cjnoyessw.twitter.hadoop.partitioner.*;
import com.cjnoyessw.twitter.hadoop.comparator.LocationComparator;


public class GeoTrendDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		conf.setMapperClass(GeoTrendMapper.class);
		conf.setReducerClass(GeoTrendReducer.class);
		conf.setCombinerClass(GeoTrendReducer.class);
